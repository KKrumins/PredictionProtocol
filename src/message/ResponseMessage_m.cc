...
ResponseMessage::ResponseMessage(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    this->packetId = 4;
    this->receiverId = 0;
    this->hops = 0;
...
ResponseMessage::ResponseMessage(const ResponseMessage& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
int ResponseMessage::getPacketId() const
{
    return this->packetId;
}

void ResponseMessage::setPacketId(int packetId)
{
    this->packetId = packetId;
}

int ResponseMessage::getReceiverId() const
{
    return this->receiverId;
}

void ResponseMessage::setReceiverId(int receiverId)
{
    this->receiverId = receiverId;
}

Route& ResponseMessage::getRoute()
{
    return this->route;
}

void ResponseMessage::setRoute(const Route& route)
{
    this->route = route;
}

int ResponseMessage::getHops() const
{
    return this->hops;
}

void ResponseMessage::setHops(int hops)
{
    this->hops = hops;
}
...
ResponseMessageDescriptor::ResponseMessageDescriptor() : omnetpp::cClassDescriptor("std::ResponseMessage", "omnetpp::cPacket")
{
...
std::string ResponseMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: {std::stringstream out; out << pp->getRoute(); return out.str();}
...
const char *ResponseMessageDescriptor::getFieldStructName(int field) const
{
    ...
    switch (field) {
        case 2: return omnetpp::opp_typename(typeid(Route));
        default: return nullptr;
    };
}
...
void *ResponseMessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    ...
    ResponseMessage *pp = (ResponseMessage *)object; (void)pp;
    switch (field) {
        case 2: return (void *)(&pp->getRoute()); break;
        default: return nullptr;
    }
}
