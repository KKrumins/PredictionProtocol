...
void HelloMessage::copy(const HelloMessage& other)
{
    ...
    this->myNeigbours = other.myNeigbours;
}
...
void HelloMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->waitInterval);
    doParsimPacking(b,this->myNeigbours);
}
...
void HelloMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->waitInterval);
    doParsimUnpacking(b,this->myNeigbours);
}

int HelloMessage::getPacketId() const
{
    return this->packetId;
}

void HelloMessage::setPacketId(int packetId)
{
...
::omnetpp::simtime_t HelloMessage::getWaitInterval() const
{
    return this->waitInterval;
}

void HelloMessage::setWaitInterval(::omnetpp::simtime_t waitInterval)
{
    this->waitInterval = waitInterval;
}

MyNeigbours& HelloMessage::getMyNeigbours()
{
    return this->myNeigbours;
}

void HelloMessage::setMyNeigbours(const MyNeigbours& myNeigbours)
{
    this->myNeigbours = myNeigbours;
}
...
HelloMessageDescriptor::HelloMessageDescriptor() : omnetpp::cClassDescriptor("std::HelloMessage", "omnetpp::cPacket")
{
...
int HelloMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='w' && strcmp(fieldName, "waitInterval")==0) return base+2;
    if (fieldName[0]=='m' && strcmp(fieldName, "myNeigbours")==0) return base+3;
...
std::string HelloMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: return simtime2string(pp->getWaitInterval());
        case 3: {std::stringstream out; out << pp->getMyNeigbours(); return out.str();}
        default: return "";
    }
}
...
bool HelloMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 2: pp->setWaitInterval(string2simtime(value)); return true;
...
const char *HelloMessageDescriptor::getFieldStructName(int field) const
{
    ...
    switch (field) {
        case 3: return omnetpp::opp_typename(typeid(MyNeigbours));
        default: return nullptr;
    };
}
...
void *HelloMessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    ...
    HelloMessage *pp = (HelloMessage *)object; (void)pp;
    switch (field) {
        case 3: return (void *)(&pp->getMyNeigbours()); break;
        default: return nullptr;
    }
}
