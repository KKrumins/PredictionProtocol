...
int RoutingPacket::getPacketId() const
{
    return this->packetId;
}

void RoutingPacket::setPacketId(int packetId)
{
    this->packetId = packetId;
}

int RoutingPacket::getSenderId() const
{
    return this->senderId;
}

void RoutingPacket::setSenderId(int senderId)
{
    this->senderId = senderId;
}

int RoutingPacket::getReceiverId() const
{
    return this->receiverId;
}

void RoutingPacket::setReceiverId(int receiverId)
{
    this->receiverId = receiverId;
}

int RoutingPacket::getDestinationNodeId() const
{
    return this->destinationNodeId;
}

void RoutingPacket::setDestinationNodeId(int destinationNodeId)
{
    this->destinationNodeId = destinationNodeId;
}

Route& RoutingPacket::getRoute()
{
    return this->route;
}

void RoutingPacket::setRoute(const Route& route)
{
    this->route = route;
}
...
RoutingPacketDescriptor::RoutingPacketDescriptor() : omnetpp::cClassDescriptor("std::RoutingPacket", "omnetpp::cPacket")
{
...
int RoutingPacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='d' && strcmp(fieldName, "destinationNodeId")==0) return base+3;
...
std::string RoutingPacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 3: return long2string(pp->getDestinationNodeId());
...
bool RoutingPacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 3: pp->setDestinationNodeId(string2long(value)); return true;
...
const char *RoutingPacketDescriptor::getFieldStructName(int field) const
{
    ...
    switch (field) {
        case 4: return omnetpp::opp_typename(typeid(Route));
        default: return nullptr;
    };
}
